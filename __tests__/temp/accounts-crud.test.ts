...
describe('Bank Account CRUD Operations', () => {
  ...
  beforeAll(async () => {
    ...
    db.exec(`
      INSERT INTO users (id, email, password, name) VALUES (1, 'test@example.com', 'hashedpassword', 'Test User');
      INSERT INTO banks (id, code, name, full_name) VALUES (1, '001', 'Banco do Brasil', 'Banco do Brasil S.A.');
    `);
  });
  ...
  test('should create a new account', async () => {
    console.log('Starting test: should create a new account');
    ...
    console.log('Inserted account ID:', accountId);
